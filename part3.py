...
def create_instance(compute, project, zone, name, bucket):
    ...
    startup_script = open(
        os.path.join(
            os.path.dirname(__file__), 'startup_script_2.sh'), 'r').read()
    config = {
        'name': name,
...
zone = "us-west1-b"
bucket = 'dcsclab6'
inside_instanceName = "instance-2"
create_instance(service, project, zone, inside_instanceName, bucket)
setTag(service, project, zone, inside_instanceName)
